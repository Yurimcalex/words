export default {
	...
	'show': 'показывать',
	'demonstrate': 'демонстрировать(показать на своем примере или что-то детально)',
	...
	'pursue': 'гнаться (за кем-то, за чем-то), предьявлять иск, добиваться',
	'follow': 'следовать',
	'solve': 'решать',
	'resolve': 'разрешать',
	...
	'witness': 'cвидетельствовать, быть свидетелем чему-то',
	'verify': 'проверять, сверять, утверждать(удостоверять)',
	'overwhelm': 'подавлять, заваливать, обуревать',
	'maintain': 'поддерживать(в том же состоянии, как физическое так и абстрактное)',
	'stay away': 'держаться подальше (от кого-то чего-то)',
	'recommend': 'рекомендовать, предлагать',
	'prioritize': 'приоритизировать, расставлять приоритеты',
	'perceive': 'воспринимать',
	'overcome': 'преодолевать(преграды, трудности)',
	'negotiate': 'вести переговоры; договариваться(неформально)',
	'justify': 'оправдавать(что-то), оправдываться(за что-то)',
	'implement': 'реализовать, применять, внедрять',
	'facilitate': 'способствовать, содействовать',
	'establish': 'устанавливать(репутацию, правила и обычаи, контакт, связь)',
	'contribute': 'вносить вклад(как денежный так и труда, енергии, времени); быть сопричастным',
	'clarify': 'уточнять, прояснять',
	'analyze': 'анализировать',
	'allocate': 'выделять, распределять',
	'reduce': 'уменьшать, снижать',
	'increase': 'увеличивать, приумножать, пополняться',
	'send': 'отправлять, посылать, присылать',
	'notice': 'замечать',
	'ignore': 'игнорировать',
	'cool': 'охлаждать, охлаждаться',
	'warm': 'согрквать, греть',
	'plant': 'сажать, насаждать, садить',
	'harvest': 'собирать урожай',
	'raise': 'повышать, поднимать; растить',
	'lower': 'понизить, опустить',
	'loathe': 'ненавидеть, испытовать отвращение',
	'conceal': 'скрыть, таить, утаивать',
	'reveal': 'раскрывать',
	'rise': 'подниматься, возвышаться, восходить, возноситься, воспрянуть, подняться на поверхность',
	'work': 'работать',
	'trust': 'доверять, доверяться',
	'doubt': 'сомневаться, усомниться, быть неуверенным',
	'delay': 'задерживать, медлить',
	'demand': 'требовать',
	'supply': 'поставлять, снабжать, восполнять, подводить',
	'encourage': 'поощрять, одобрять, приободрять',
	'discourage': 'обескураживать, отбивать охоту, расхолаживать',
	'unite': 'обьеденяться, обьеденять, соединять',
	'obey': 'подчиняться, повиноваться, выполнять приказы',
	'defy': 'бросать вызов, открыто неповиноваться',
	'punish': 'наказывать, карать, расправляться',
	'praise': 'хвалить, восхвалять',
	'amplify': 'усиливать',
	'confine': 'ограничивать, держать в заперти',
	'broadcast': 'транслировать, вещать',
	'bless': 'благословлять, славословить',
	'curse': 'проклинать, клясть, кощунствовать',
	'expand': 'расширять, увеличиваться в обеме, становиться более общительным',
	'contract': 'сужаться',
	'frown': 'хмуриться, насупиться',
	'glorify': 'прославлять, захваливать',
	'dishonor': 'безчестить, отказываться от акцепта/платежа',
	'vanish': 'исчезнуть, стремиться к нулю',
	'appear': 'появляться, предстать, показываться, привидеться, заявляться, издаваться, обозначаться',
	'evict': 'выселять',
	'invite': 'приглашать',
	'continue': 'продолжать (какую-то деятельность), продолжаться',
	'misunderstand': 'неправильно понять, не понять',
	'pacify': 'умиротворять, усмирять, восстанавливать мир',
	'exacerbate': 'обострять',
	'stabilize': 'стабилизировать',
	'upset': 'расстраивать, огорчать',
	'authorize': 'разрешать, санкционировать, уполномачивать',
	'supersede': 'заменять, вытеснять, смещать',
	'refer': 'ссылаться, относиться',
	'repeal': 'отменить',
	'deem': 'считать, полагать, думать, размышлять',
	'invalidate': 'аннулировать, признавать недействительным',
	'validate': 'придавать юридическую силу',
	'construe': 'толковать, истолковывать',
	'promote': 'продвигать',
